 ...
 * Paid users see "Unlocked ✦" in mauve. Minimal styling.
 */
export default function UsageBar({ isPaid, auditCount, askBlairCount, maxFreeAudits = 3, maxFreeQuestions = 15, onSignOut }) {
  if (isPaid) {
    return (
